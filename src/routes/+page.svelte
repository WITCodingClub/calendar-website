...
<div class="flex justify-center items-center mt-8 px-4 sm:px-6">
    <div class="rounded-3xl w-full max-w-6xl px-4 sm:px-8 md:px-16 py-8 sm:py-12">
        <div class="flex flex-col sm:flex-row justify-center items-end gap-6 md:gap-8">
            <img src="/settings.png" alt="Settings page" class="outline outline-tertiary w-full max-w-[420px] sm:w-[clamp(220px,24vw,420px)] lg:w-[clamp(240px,26vw,460px)] lg:max-w-[460px] h-auto aspect-16/10 object-contain p-2 bg-[rgb(var(--m3-scheme-surface))] rounded-xl shadow-md transition-transform duration-200 ease-in-out sm:transform sm:rotate-2 sm:translate-y-[8px] sm:hover:rotate-1 sm:hover:translate-y-[2px] hover:scale-[1.03] hover:shadow-xl order-2 sm:order-0 mx-auto" />
            <img src="/calendar.png" alt="Primary page" class="outline outline-primary w-full max-w-[640px] sm:w-[clamp(300px,36vw,640px)] lg:w-[clamp(360px,40vw,720px)] lg:max-w-[720px] h-auto aspect-16/10 object-contain p-2 bg-[rgb(var(--m3-scheme-surface))] rounded-xl shadow-lg transition-transform duration-200 ease-in-out sm:transform sm:-translate-y-[8px] z-10 sm:hover:-translate-y-[6px] hover:scale-[1.03] hover:shadow-xl order-1 sm:order-1 mx-auto" />
